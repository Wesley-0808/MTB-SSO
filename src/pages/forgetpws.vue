  ...
  <div id="page" class="page page-cn page-pc page-banner page-wrapper-full">
    ...
    <div class="wrapper">
      <main class="container">
        <button type="primary" aria-label="返回" style="width: 80px;height: 32px;padding: 0px 8px;" @click="back"
          ...
          <svg t="1686655706696" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2378" width="16" height="16">
            <path
          ...
          <div class="reset-password-box">
            <div class="verify-user">
              <div class="mtb-form-input">
                <div class="mtb-input-label">暂不支持的功能，请找管理员重置账号</div>
                <!-- <div class="mtb-input-label">请输入已注册的账号</div> -->
                <div class="mtb-input-group">
                  <!---->
                  <!-- <div class="mtb-input-wrapper">
                    <input name="username" placeholder="" maxlength="100" aria-label="请输入已注册的账号" type="text"
                      class="mtb-input" />
                  </div> -->
                </div>
                <!---->
              ...
              <!---->
              <div class="action">
                <button type="primary" aria-label="下一步"
                  class="mtb-btn mtb-btn-black mtb-btn-primary mtb-btn-large mtb-btn-block">
                  <!----><span> 下一步 </span>
                </button>
              </div>
    ...
    <footer class="mtb-footer text-center" style="opacity: 1">
      <div class="mtb-footer-copyright">
        <span class="mr-1">Copyright © 2023 顺德中专团委学生会媒体部 版权所有.</span>
      </div>
    </footer>
  </div>
</template>
...
<script>
import background from './backgroundImage.vue'
